...
public class ROVER_04 {
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			System.out.println("ROVER_04 currentLoc at start: " + currentLoc);
			...
			//System.out.println("ROVER_04 equipment list results drive " + equipment.get(0));
			System.out.println("ROVER_04 equipment list results " + equipment + "\n");
			
	

			// ***** do a SCAN *****
			//System.out.println("ROVER_04 sending SCAN request");
			this.doScan();
			...
			//System.out.println("ROVER_04 currentLoc after recheck: " + currentLoc);
			//System.out.println("ROVER_04 previousLoc: " + previousLoc);
